...
_MAP = [
    ...
    evdev.ecodes.KEY_1,            evdev.ecodes.KEY_Q,
    evdev.ecodes.KEY_W,

    # gun 2
    evdev.ecodes.KEY_LEFT,         evdev.ecodes.KEY_RIGHT,
    evdev.ecodes.KEY_DOWN,         evdev.ecodes.KEY_UP,
    evdev.ecodes.KEY_ENTER,            evdev.ecodes.KEY_Z,
    evdev.ecodes.KEY_X,      evdev.ecodes.KEY_B,
    ...
    evdev.ecodes.KEY_RIGHTSHIFT,   evdev.ecodes.KEY_5,
